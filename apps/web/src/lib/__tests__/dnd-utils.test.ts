...
import type { NormalizedBoard, CardData, StatusValue } from "~/types/board-types";
...
function createMockCard(id: string, position: string, status: StatusValue = "todo", priority: Priority = "none"): CardData {
  return {
    id,
    displayId: `RAV-${id}`,
    title: `Card ${id}`,
